% Autogenerated file: Fri Jul 11 12:38:42 2025
...
wr = coder.internal.writeDataInterfacesToCodeDescriptor("HolaMundo",pwd);
...
wr.fFullModel.componentInterface.Parameters;
    ...
    func_Initialize_Prototype.Return     = tmpRet;
        ...
        func_Initialize_Prototype.HeaderFile = 'HolaMundo.h';
    func_Initialize_Prototype.SourceFile = 'HolaMundo.c';
    ...
    func_Initialize_Interface.ActualReturn = tmpActualReturn;
        ...
        func_Initialize_Prototype.Name = 'HolaMundo_initialize';
    ...
    func_OutputUpdate_Prototype.Return     = tmpRet;
        ...
        func_OutputUpdate_Prototype.HeaderFile = 'HolaMundo.h';
    func_OutputUpdate_Prototype.SourceFile = 'HolaMundo.c';
    ...
    func_OutputUpdate_Interface.ActualReturn = tmpActualReturn;
            ...
            func_OutputUpdate_Prototype.Name = 'HolaMundo_step';
    ...
    func_Terminate_Prototype.Return     = tmpRet;
        ...
        func_Terminate_Prototype.HeaderFile = 'HolaMundo.h';
    func_Terminate_Prototype.SourceFile = 'HolaMundo.c';
    ...
    time_terminate = wr.fFullModel.componentInterface.TimingProperties(getIndexFromTimingInternalId(wr.fFullModel.componentInterface.TimingInternalIds, -1));
        func_Terminate_Interface.Timing = time_terminate;
                func_Terminate_Prototype.Name = ['HolaMundo_terminate'];
            ...
            type_RTModel.Identifier = 'RT_MODEL_HolaMundo_T';
        ...
        CoderDescVar_RTModel.Identifier = 'HolaMundo_M_';
        CoderDescVar_RTModel.Type = CodeDescPtrtype_RTModel_1_0.BaseType;
        CoderDescVar_RTModel.VarOwner = 'HolaMundo';
            
            CoderDescVar_RTModel.DeclarationFile = 'HolaMundo.h';
            CoderDescVar_RTModel.DefinitionFile  = 'HolaMundo.c';
        ...
        % Pointer Variable: CodeDescPtrVar_RTModel
            ...
            CodeDescPtrVar_RTModel.Identifier      = 'HolaMundo_M';
            CodeDescPtrVar_RTModel.TargetVariable = CoderDescVar_RTModel;
            
        CodeDescPtrVar_RTModel.VarOwner = 'HolaMundo';
            CodeDescPtrVar_RTModel.DeclarationFile = 'HolaMundo.h';
            CodeDescPtrVar_RTModel.DefinitionFile = 'HolaMundo.c';
    ...
    time_terminate = codeInfo.TimingProperties(getIndexFromTimingInternalId(codeInfo.TimingInternalIds, -1));
        ...
        Var_RTModel.Identifier = 'HolaMundo_M_';
        Var_RTModel.Type = Ptrtype_RTModel_1_0.BaseType;
        Var_RTModel.Owner = 'HolaMundo';
            
            Var_RTModel.DeclarationFile = 'HolaMundo.h';
            Var_RTModel.DefinitionFile  = 'HolaMundo.c';


        % Pointer Variable: PtrVar_RTModel

            PtrVar_RTModel = RTW.PointerVariable(Ptrtype_RTModel_1_0, 'HolaMundo_M', Var_RTModel);
            
        PtrVar_RTModel.Owner = 'HolaMundo';
            PtrVar_RTModel.DeclarationFile = 'HolaMundo.h';
            PtrVar_RTModel.DefinitionFile = 'HolaMundo.c';
