###########################################################################
## Makefile generated for component 'ObtenerValoresv2'. 
## 
## Makefile     : ObtenerValoresv2.mk
## Generated on : Fri Jul 11 02:26:57 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/ObtenerValoresv2.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/ObtenerValoresv2.elf
...
DEFINES_STANDARD = -DMODEL=ObtenerValoresv2 -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.o : $(START_DIR)/ObtenerValoresv2_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/ObtenerValoresv2_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/ObtenerValoresv2_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ObtenerValoresv2.o : $(START_DIR)/ObtenerValoresv2_ert_rtw/ObtenerValoresv2.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ObtenerValoresv2_data.o : $(START_DIR)/ObtenerValoresv2_ert_rtw/ObtenerValoresv2_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/ObtenerValoresv2_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
